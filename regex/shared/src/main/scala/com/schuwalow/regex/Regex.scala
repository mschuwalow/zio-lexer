...
object Regex {
  ...
  final private[Regex] case class CharacterSet(values: Set[Char])
      extends Regex {
  ...
  final private[Regex] case class And(
    first: Regex,
    second: Regex)
      extends Regex {
  ...
  final private[Regex] case class Or(
    first: Regex,
    second: Regex)
      extends Regex {
  ...
  final private[Regex] case class Sequence(
    first: Regex,
    second: Regex)
      extends Regex {
  ...
  final private[Regex] case class Repetition(value: Regex) extends Regex {
    self =>
  ...
  final private[Regex] case class Complement(pattern: Regex) extends Regex {
